...
module Tox.Core.Bits.Get
            ...
            , word64be
            , byteString
            , Tox.Core.Bits.Get.getByteString
            , Tox.Core.Bits.Get.getLazyByteString
            , Tox.Core.Bits.Get.isEmpty
...
getLazyByteString n = do
  ...
  case o of
    ...
    _ -> L.fromChunks . (:[]) <$> Tox.Core.Bits.Get.getByteString n
