...
{-# LANGUAGE LambdaCase         #-}
{-# LANGUAGE StrictData         #-}
module Tox.Network.Core.TransportProtocol where
...
import qualified Tox.Core.Bits.Get         as Bits (getBool)
import qualified Tox.Core.Bits.Put         as Bits (putBool)
import           Tox.Network.Core.Encoding      (BitEncoding, bitGet, bitPut)
